...
namespace vulkan {
	VulkanPipeline::VulkanPipeline(VulkanDevice& device, const std::string& vertFilepath, const std::string& fragFilepath, const PipelineConfigInfo& configInfo) : vulkanDevice{device} {
	...
	void VulkanPipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo) {
		...
		// Combine viewport and scissor range
		...
		// Rasterize the image to break the geometry into fragments
		...
		// Depth - Currently disabled
		configInfo.rasterizationInfo.depthBiasConstantFactor = 0.0f;  // Optional
		configInfo.rasterizationInfo.depthBiasClamp = 0.0f;           // Optional
		configInfo.rasterizationInfo.depthBiasSlopeFactor = 0.0f;     // Optional

		// MSAA or Multisample Anti-Aliasing shades the color of a pixel based on how much of the object is in the pixel
		...
		// Controls how to blend colors when they overlap in the same pixel
		...
		// Depth testing for determing the distance something is from the perspective in relation to other "layers"
