...
namespace vulkan {
    ...
    VulkanSwapChain::VulkanSwapChain(VulkanDevice& deviceRef, VkExtent2D extent, std::shared_ptr<VulkanSwapChain> previous) : device{ deviceRef }, windowExtent{ extent }, oldSwapChain{ previous } {
        init();
    ...
    // Present mode comparisons https://www.youtube.com/watch?v=IUYH74MqxOA&list=PL8327DO66nu9qYVKLDmdLW_84-yE4auCR&index=6 @ 8:31
