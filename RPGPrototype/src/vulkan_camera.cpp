...
namespace vulkan {
	...
	void VulkanCamera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
		assert(direction != glm::vec3(0.0f) && "Direction cannot equal 0");
		...
		//viewMatrix = glm::lookAt(position, position + w, up);
		//inverseViewMatrix = glm::inverse(viewMatrix);
	}

	void VulkanCamera::setDistortionView(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
		assert(direction != glm::vec3(0.0f) && "Direction cannot equal 0");
		assert(direction != glm::vec3(0.0f) && "Direction cannot equal 0");
	...
	void VulkanCamera::setViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up) {
		assert(target != glm::vec3(0.0f) && "Target direction cannot equal 0");
